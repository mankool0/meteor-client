...
public abstract class AbstractBoatMixin {
    @ModifyExpressionValue(method = "controlBoat", at = @At(value = "FIELD", target = "Lnet/minecraft/world/entity/vehicle/AbstractBoat;inputLeft:Z", opcode = Opcodes.GETFIELD))
    ...
    @ModifyExpressionValue(method = "controlBoat", at = @At(value = "FIELD", target = "Lnet/minecraft/world/entity/vehicle/AbstractBoat;inputRight:Z", opcode = Opcodes.GETFIELD))
