...
public class GL {
    ...
    /** Only call this while one of our own vertex arrays is bound, the binding is stored in the active vao. */
    ...
    public static void uniformFloat4Array(int location, float[] v) {
