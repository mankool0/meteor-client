...
public class Bounce extends ElytraFlightMode {
    ...
    public void onTick() {
        ...
        if (mc.options.jumpKey.isPressed() && !mc.player.isFallFlying() && !elytraFly.manualTakeoff.get()) mc.getNetworkHandler().sendPacket(new ClientCommandC2SPacket(mc.player, ClientCommandC2SPacket.Mode.START_FALL_FLYING));
